...
![Logo Apache Tomcat](../img/10/2025-05-18_12-52-10.png)
...
Aquí tienes una introducción clara y comparativa a Apache Tomcat en relación con Apache HTTP Server y NGINX, incluyendo cómo conviven y las opciones típicas de uso:
...
3. **Apache + Tomcat con `mod_proxy_http`**
	...
	* Menos usado actualmente debido a problemas de seguridad en AJP (por ejemplo, [Ghostcat](https://nvd.nist.gov/vuln/detail/CVE-2020-1938)).  
